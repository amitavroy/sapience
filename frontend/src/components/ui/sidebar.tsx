  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "peer-data-[disabled]:text-sidebar-foreground/50 peer-data-[disabled]:hover:bg-transparent",
        "peer-data-[state=open]:bg-sidebar-accent peer-data-[state=open]:text-sidebar-accent-foreground",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 after:md:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[disabled]:opacity-0 md:opacity-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "peer-data-[disabled]:text-sidebar-foreground/50",
        "peer-data-[state=open]:bg-sidebar-accent peer-data-[state=open]:text-sidebar-accent-foreground",
        "peer-data-[variant=inset]:text-sidebar-foreground/70",
        className
      )}
      {...props}
    />
